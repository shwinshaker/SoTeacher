...
from helper.util import get_teacher_name, get_lr, Dict2Obj
...
def main(config_file):
    ...
    if opt.dataset == 'cifar100':
        ...
        if opt.distill in ['crd']:
            train_loader, val_loader, n_data = get_imagenet_dataloader_sample(dataset='tiny-imagenet',
                                                                              batch_size=opt.batch_size,
                                                                              num_workers=opt.num_workers,
                                                                              k=opt.nce_k)
        else:
            train_loader, val_loader, n_data = get_imagenet_dataloader(dataset='tiny-imagenet',
                                                                       batch_size=opt.batch_size,
                                                                       num_workers=opt.num_workers,
                                                                       is_instance=True)
        n_cls = 200
