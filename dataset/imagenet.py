...
def get_data_folder_tiny_imagenet():
    """
    return server-dependent path to store the data
    """
...
def get_test_loader(dataset='imagenet', batch_size=128, num_workers=8):
    ...
    if dataset == 'imagenet':
        ...
        data_folder = get_data_folder_tiny_imagenet()
...
def get_imagenet_dataloader_sample(dataset='imagenet', batch_size=128, num_workers=8, is_sample=True, k=4096):
